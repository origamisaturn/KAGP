...
$$
    ...
    q_D - q_0 - \dot q(t_0)T_{go}
        ...
        = \int_{t_0}^T \int_{t_0}^t p_1(s) ds \; dt
            + \int_{t_0}^T \int_{t_0}^t p_2(s) ds \; dt
$$
...
$$
$c_1$ and $c_2$ can be solved from the matrix equation by inverting the $F$ matrix. With $c_1$ and $c_2$ found, the general guidance equation is solved.
