...
class TestGuidance:
    ...
    def _parse_input(self, input_dict):
        ...
        true_anomaly = input_dict['mission']['true_anomaly']
        gravitational_parameter = input_dict['mission'][
            'gravitational_parameter']
        
        target_r, target_r_dot, target_v_theta = self._orbit_to_velocity(
        ...
        exhaust_velocity, mass_flow = self._convert_engine_data(
    ...
    def _convert_engine_data(self, specific_impulse, thrust):
        g0 = 9.80665
