...
class TestRadialControlGuidanceWithEstimator(om.Group):
    def setup(self):
...
class TestGuidance3:
    def __init__(self, input_dict, log_interface, terminal_time_guess = 438):
        self.log_interface = log_interface
        model = TestRadialControlGuidanceWithEstimator()
        self._openmdao_problem = om.Problem(model)
        self._openmdao_problem.setup()
        self._parse_input(input_dict)
...
class TestRadialControlGuidance4(om.Group):
    def setup(self):
        self.add_subsystem('engine_estimator', EnginePropertyEstimator(),
                           promotes=['*'])
        self.add_subsystem('radial_control', RadialControl(),
...
class TestGuidance4:
    def __init__(self, input_dict, log_interface, terminal_time_guess = 351):
        self.log_interface = log_interface
        model = TestRadialControlGuidance4()
        self._openmdao_problem = om.Problem(model)
        self._openmdao_problem.setup()
        self._parse_input(input_dict)
...
class TestRadialControlGuidance5(om.Group):
    def setup(self):
        self.add_subsystem('engine_estimator', EnginePropertyEstimator(),
                           promotes=['*'])
        self.add_subsystem('radial_control', RadialControl(),
...
class TestGuidance5:
    def __init__(self, input_dict, log_interface, terminal_time_guess = 351):
        self.log_interface = log_interface
        model = TestRadialControlGuidance5()
        self._openmdao_problem = om.Problem(model)
        self._openmdao_problem.setup()
        self._parse_input(input_dict)
