...
class TestRot(unittest.TestCase):
    def test_funct__body2global_rot__1(self):
        ...
        self.assertTrue(almost_equal(expected_global_axes, calculated_global_axes, tol=1e-8))

        expected_body_axes = np.identity(3)
        calculated_body_axes = global2body_rot(roll, pitch, yaw, pos_global) @ calculated_global_axes
        self.assertTrue(almost_equal(expected_body_axes, calculated_body_axes, tol=1e-8))
    ...
    def test_funct__pcf2global_rot__1(self):
        ...
        self.assertTrue(almost_equal(expected_global_axes_2, calculated_global_axes_2, tol=1e-8))
